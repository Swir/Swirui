...
The merged chart packages are synchronized here without widening scope: PR #145 passed exact-head CI #883 plus Cartesian Charts Native Gate #4 for retained line/area/bar charts; PR #146 passed exact-head CI #888 plus Radial Charts Native Gate #4 for retained pie/donut charts; PR #148 passed exact-head CI #894 plus Advanced Charts Native Gate #3 for retained scatter/heatmap/radar charts; and PR #150 passed exact-head CI #900 plus Specialized Charts Native Gate #1 for retained gauge/candlestick/timeline charts before merge. No additional project-percentage points are claimed by this post-0.5 work.
