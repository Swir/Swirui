...
//!
//! Python remains the public developer API. This crate owns the performance-critical renderer
//! path while preserving stable framework-level contracts above it.
